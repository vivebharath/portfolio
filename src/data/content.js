...
export const socialLinks = {
    linkedin: "https://linkedin.com/in/vivek-narasingaperumal",
    github: "https://github.com/vivebharath",
    //   twitter: "https://twitter.com/vivek_narasingaperumal",
};

export const aboutData = {
    paragraphs: [
        "I am a seasoned software developer with a diverse skill set encompassing a range of technologies and tools. Currently, I work as a Solution Engineer, dedicating my expertise to building scalable backend systems and dynamic user interfaces.",
        "Throughout my career journey, I have consistently demonstrated the ability to deliver projects on time, maintaining a keen focus on efficiency, and crafting effective business solutions for my clients.",
        "I am unwavering in my commitment to delivering projects of the highest quality. I'm open to opportunities where I can contribute, learn, and grow."
    ],
    skills: [
        'ReactJS', 'JavaScript','ES6','TypeScript', 'HTML5', 'CSS','Bootstrap','tailwindcss',
        'Redux Thunk', 'Node.js', 'Express JS',
        'MongoDB', 'MySQL', 'Firebase', 'REST ful APIs', 'Git', 'Java', 'Spring Boot','Agile'
    ]
};
...
export const projectsData = [
    {
        ...
        usedSkils: ["React", "Redux", "Node.js", "Express", "MongoDB", "REST APIs", "HTML-to-PDF Library"],
    ...
    },
    {
        ...
        usedSkils: ["React", "Redux", "Node.js", "Express", "Firebase"],
    ...
    },
    {
        ...
        usedSkils: [ "React", "Redux", "Java", "SpringBoot", "Microservices","MySQL", "Firebase"],
